...
import (
	...
	versioned "scaling-demo/pkg/client/clientset/versioned"
	internalinterfaces "scaling-demo/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "scaling-demo/pkg/client/listers/autoscaling/v1alpha1"
	time "time"
